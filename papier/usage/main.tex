...
Le fait de passer a une surveillance communautaire réduire l'influence de la discussion et déplace le focus sur le temps au champs


Il faudrait refaire un saltelli en ajoutant le nombre de jeune pousse protégé, ce qui fera se déplacé le narratif sur le nombre de jeune pousse détrute par les agriculteurs aux même.
